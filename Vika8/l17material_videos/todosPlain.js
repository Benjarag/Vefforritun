...
app.get('/users/:userId/notes/:noteId', (req, res) => {
    res.status(200).json({'message': "Get note with id " + req.params.noteId + " for user with id " + req.params.userId});
});
...
app.delete('/users/:userId/notes/:noteId', (req, res) => {
    res.status(200).json({'message': "Delete note with id " + req.params.noteId + " for user with id " + req.params.userId});
});
